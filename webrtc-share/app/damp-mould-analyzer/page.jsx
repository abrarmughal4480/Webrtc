...
import PagesAnalyzer from '@/components/section/PagesAnalyzer';
import DemoCode from '@/components/DemoCode';
import { toast } from "sonner";
import { ArrowLeft } from 'lucide-react';
import Link from 'next/link';

export default function DampAndMouldAnalyzerPage() {
  ...
  const handleDemoCodeSubmit = (code, errorData) => {
    if (errorData && errorData.error) {
      ...
      setDemoCodeError(errorData.error);
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1e3a8a] via-[#1e40af] to-[#3b82f6] relative overflow-hidden">
